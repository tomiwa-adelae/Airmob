...
export const homeNavLinks = [
  ...
  { slug: "/sustainability", label: "Sustainability", icon: IconLeaf },
  { slug: "/news", label: "News", icon: IconArticle },
];

export const PHONE_NUMBER = "+234 809 844 0057";
export const EMAIL = "airmobnigerialimited@gmail.com";
export const TECH_EMAIL = "airmobnigerialimited@gmail.com";
export const ADDRESS = "Ikeja, Lagos, Nigeria";
// export const HERO_VIDEO = "https://airmob.t3.storage.dev/hero.mp4";
export const HERO_VIDEO =
  "https://airmob.t3.storage.dev/12856470_1280_720_60fps.mp4";
...
export const articles = [
  {
    slug: "optimizing-lubricant-viscosity",
    category: "Technical",
    date: "Feb 04, 2026",
    ...
    content:
      "As Nigeria expands its industrial manufacturing footprint, the demand for specialized lubricants that can withstand extreme thermal fluctuations has never been higher...",
  ...
  },
  {
    ...
    category: "HSE",
    date: "Nov 15, 2025",
    title: "Celebrating 1 Million Man-Hours Without LTI",
    excerpt:
      "A testament to our rigorous safety protocols and culture of zero compromise.",
    content:
      "Safety is not a department; it is a mindset. Every member of the AIRMOB team is empowered to halt operations if risks are identified...",
    image: "/assets/images/AI.jpg",
    readTime: "3 min read",
    author: "HSE Director",
    color: "orange",
  },
  {
    ...
    category: "Technical",
    date: "Oct 28, 2025",
    title: "Advances in Subsea Well Intervention Technology",
    excerpt:
      "How new tool strings are making deep-water maintenance more cost-effective.",
    content:
      "By utilizing light well intervention vessels, we are helping operators maintain production without the high costs of mobilizing a full rig...",
    image: "/assets/images/AI.jpg",
