...
// This would be in app/news/[slug]/page.tsx
...
export default function NewsArticlePage({
  ...
  if (!article) {
    notFound(); // Redirects to 404 if slug doesn't exist
  }
  ...
  return (
    <div className="pt-8 pb-16">
      <div className="container">
        ...
        {/* The rest of your article layout stays the same, 
            using {article.content} where needed */}
      </div>
    </div>
  );
}
